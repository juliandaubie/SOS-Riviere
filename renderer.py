import pygame
from menu import SCREEN_W, SCREEN_H, HEADER_COLOR, BG_COLOR
from map import px_to_tile, is_valid_tile, PATH_SET, MAP_X, MAP_Y, ROWS, TILE_SIZE
...
def draw_header(screen, font_big, font_small):
    pygame.draw.rect(screen, HEADER_COLOR, (0, 0, SCREEN_W, 50))

    title = font_big.render("🌿  ECO TOWER DEFENSE  —  Carte de base", True, (160, 230, 130))
    screen.blit(title, (20, 12))

    hint = font_small.render(
        "Glissez une tour sur la carte  •  Clic droit = supprimer  •  ESC = menu",
        True, (100, 160, 90)
    )
...
def draw_frame(screen, font, font_small, font_big, game_map, palette,
               dragging_item, message, message_timer, mx, my):
    """Dessine une frame complète du jeu."""
    draw_background(screen)
    draw_header(screen, font_big, font_small)
